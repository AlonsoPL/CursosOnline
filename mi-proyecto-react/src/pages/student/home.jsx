                ...
                <div className="box-body rounded-5 p-5">
                        ...
                        <div className="box-datos">
                            <div className="user text-end py-2 d-flex align-items-center justify-content-end">
                                ...
                                <div className="dropdown ms-2">
                                    <button className="btn btn-sm dropdown-toggle" type="button" id="userDropdown" data-bs-toggle="dropdown" aria-expanded="false">
                                        Hector Ramon
                                    </button>
                            ...
                            <div className="row mx-0 justify-content-end gap-4">
                                <div className="col-5 rounded-3 card-porcentaje">
                                    <div className="py-3 row mx-0">
                                        ...
                                        <div className="col-12 mt-3 px-0" style={{ display: "flex", alignItems: "center", gap: "10px" }}>
                    ...
                    <div className="container-2 d-flex rounded-5 mt-4">
                        ...
                        <div className="text-home d-flex flex-column justify-content-center px-3">
                            ...
                            <p className="text-2">mejora cada dia</p>
                            <span className="text-3">Domina nuevas habilidades y alcanza tus
                                metas con los mejores cursos online
                            </span>
                        </div>
                    </div>
                    <div className="container-3 row mx-0 mt-3">
                        <div className="col-8 row mx-0 gap-4 justify-content-between">
                            ...
                            <div className="col-5 rounded card-curso row mx-0 p-2">
                                ...
                                <div className="col-12 letra-mediana p-2">
                                    <p className="mb-0">Digital Marketing Ethics: Navigating the Ethical Landscape</p>
                                </div>
                            </div>
                            <div className="col-5 rounded card-curso row mx-0 p-2">
                                <div className="col-6 img-card px-0 rounded">
                        ...
                        <div className="col-4">
                            ...
                            <div className="col-12 card-actividades p-3 rounded mb-3">
                                <div className="d-flex align-items-center gap-2 mb-2">
                                    ...
                                    <p className="mb-0 letra-mediana">Hacer la actividad de Word....</p>
                                </div>
                            ...
                            <div className="col-12 card-actividades p-3 rounded">
                                <div className="d-flex align-items-center gap-2 mb-2">
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                        width="28"
                                    ...
                                    <p className="mb-0 letra-mediana">Avance de Proyecto en Python....</p>
                                </div>
                                <div className="d-flex justify-content-end gap-3">
                                    <button className="btn-t1">Omitir</button>
                                    <button className="btn-t2 p-2 rounded">Ir a Actividad</button>
