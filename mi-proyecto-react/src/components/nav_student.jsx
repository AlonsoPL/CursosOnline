...
function NavStudent() {
    return (
        <div className="contenedor-nav d-flex flex-column text-start gap-3 mt-4">
            <Link to="/home" className="a-nav py-3 px-3">
            ...
            <Link to="/cursos" className="a-nav py-3 px-3">
            ...
            <Link to="/mis-cursos" className="a-nav py-3 px-3">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-backpack3" viewBox="0 0 16 16">
